...
const FavoriteFighter = () => {
  ...
  return (
    <>
      {followed.length === 0 ? (
        <LikeProfile title="Currently, you are not following any fighters. Please follow some fighters from suggestions listed below to add them to the Favorites list" />
      ) : (
